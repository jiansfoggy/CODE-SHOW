classdef face_morph_r
    ...
    methods (Static)
        ...
        function fimage = start_morph(alpha,tri,ted_p,hillary_p,fimg_p,t_1,h_1,fimage,method)
            ...
            t_Rect = [tri_t(1,1)-t_r(1),tri_t(1,2)-t_r(2);tri_t(2,1)-t_r(1),tri_t(2,2)-t_r(2);tri_t(3,1)-t_r(1),tri_t(3,2)-t_r(2);];
            h_Rect = [tri_h(1,1)-h_r(1),tri_h(1,2)-h_r(2);tri_h(2,1)-h_r(1),tri_h(2,2)-h_r(2);tri_h(3,1)-h_r(1),tri_h(3,2)-h_r(2);];
